...
#define XML_PATH "xml/pacientesGuadalupe.xml"
#define XML_BACKUP_PATH "backup/"
#define XML_NAME "pacientesGuadalupe.xml" /* Mantido para servir de referencia aos tamanhos de string,  deve ser mudado para um posto com nome maior que "Guadalupe"*/
