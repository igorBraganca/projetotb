...
printf ("<html>\n");
printf ("<head>\n");
printf ("	<title>Question&aacute;rio Custos - Parte A</title>\n");
...
printf ("	tabFields[0] = [\"onde_mora\", \"01 - Onde voc&ecirc; mora?\"];\n");
printf ("	tabFields[1] = [\"como_veio_posto\", \"02 - Como voc&ecirc; veio ao posto? Em qual transporte?\"];\n");
printf ("	tabFields[2] = [\"custo_transporte\", \"02.1 - Se voc&ecirc; n&atilde;o veio a p&eacute;, quanto custou o transporte?\"];\n");
printf ("	tabFields[3] = [\"companhia\", \"03 - Voc&ecirc; est&aacute; acompanhado?\"];\n");
printf ("	tabFields[4] = [\"saiu_casa\", \"04 - Que horas voc&ecirc; saiu de casa?\"];\n");
printf ("	tabFields[5] = [\"chegou_posto\", \"05 - Que horas voc&ecirc; chegou no posto?\"];\n");
printf ("	tabFields[6] = [\"horario_medico\", \"06 - Que horas voc&ecirc; viu o m&eacute;dico?\"];\n");
printf ("	tabFields[7] = [\"tempo_saiu_de_casa\", \"07 - Quanto tempo levou desde que voc&ecirc; saiu de casa at&eacute; ver o m&eacute;dico?\"];\n");
printf ("	tabFields[8] = [\"pernoite\", \"08 - Amanh&atilde; voc&ecirc; ter&aacute; que voltar para trazer outra amostra de escarro. Onde voc&ecirc; vai passar a noite?\"];\n");
printf ("	tabFields[9] = [\"custo_pernoite\", \"08.1 - Voc&ecirc; ter&aacute; que pagar o pernoite? Quanto voc&ecirc; dever&aacute; gastar?\"];\n");
printf ("	tabFields[10] = [\"custo_amigos\", \"08.2 - Voc&ecirc; trouxe algo para os seus amigos?\"];\n");
printf ("	tabFields[11] = [\"comeu_bebeu\", \"09 - Desde que voc&ecirc; saiu de casa, voc&ecirc; comeu ou bebeu alguma coisa? Quanto custou?\"];\n");
printf ("	tabFields[12] = [\"pagar_algo_posto\", \"10 - Voc&ecirc; teve que pagar algo aqui no posto? Quanto custou?\"];\n");
printf ("	tabFields[13] = [\"profissao\", \"12 - Qual a sua profiss&atilde;o?\"];\n");
printf ("	tabFields[14] = [\"perdeu_aula\", \"11.1 - Voc&ecirc; perdeu aula hoje?\"];\n");
printf ("	tabFields[15] = [\"deixou_ganhar_dinheiro\", \"13 - Deixou de ganhar dinheiro hoje para poder vir ao posto?  Quanto?\"];\n");
printf ("	tabFields[16] = [\"quem_pagou\", \"14 - Quem pagou pela bebida, comida, transporte, hotel, etc.? Voc&ecirc; ou seus acompanhantes?\"];\n");
printf ("	tabFields[17] = [\"custo_acompanhante\", \"15 - Quanto voc&ecirc; gastou com o seu acompanhante?\"];\n");
printf ("	tabFields[18] = [\"estudante\", \"11 - Voc&ecirc; &eacute; estudante?\"];\n");
printf ("	\n");
...
printf ("	<h3>Projeto - Novos M&eacute;todos Diagn&oacute;sicos em TB pulmonar - Policlinica Augusto Amaral Peixoto-SMS-RJ</br></h4>\n");
printf ("	<h4>Question&aacute;rio Custos</h3>\n");
...
printf ("			<td><input name=\"ondeMora\" type=\"radio\" value=\"rio\" onClick=\"ocultaLinha('parteA', 8)\">Munic&iacute;pio do Rio</td>\n");
...
printf ("			<td><input name=\"transporte\" type=\"radio\" value=\"pe\" onClick=\"ocultaLinha('parteA', 2)\">A p&eacute;</td>\n");
printf ("			<td><input name=\"transporte\" type=\"radio\" value=\"onibus\" onClick=\"exibeLinhaOculta('parteA', 2)\">&Ocirc;nibus</td>\n");
printf ("			<td><input name=\"transporte\" type=\"radio\" value=\"taxi_carro\" onClick=\"exibeLinhaOculta('parteA', 2)\">T&aacute;xi/carro</td>\n");
printf ("		</tr>\n");
printf ("		\n");
...
printf ("			<td><input name=\"acompanhadoA\" type=\"radio\" value=\"nao\" onClick=\"ocultaLinha('parteA', 17);numeroAcompanhantesA.value='NA'; numeroAcompanhantesA.readOnly = true\">N&atilde;o</td>\n");
printf ("			<td>N&ordm; de pessoas: <input name=\"numeroAcompanhantesA\" type=\"text\" maxlength=\"2\" size=\"1\" onBlur=\"validarCampoNumerico(this)\"></td>\n");
printf ("		</tr>\n");
printf ("		\n");
...
printf ("			<td><input name=\"pagarPernoite\" type=\"radio\" value=\"nao\" onclick=\"custoPernoite.value='0'; custoPernoite.readOnly = true\">N&atilde;o</td>\n");
...
printf ("			<td><input name=\"trouxeAlgoAmigos\" type=\"radio\" value=\"nao\" onclick=\"custoAmigos.value='0'; custoAmigos.readOnly = true\">N&atilde;o</td>\n");
...
printf ("			<td><input name=\"comeuBebeuA\" type=\"radio\" value=\"nao\" onclick=\"custoComidaBebidaA.value='0'; custoComidaBebidaA.readOnly = true\">N&atilde;o</td>\n");
...
printf ("			<td><input name=\"pagarPostoA\" type=\"radio\" value=\"nao\" onclick=\"custoPostoA.value='0'; custoPostoA.readOnly = true\">N&atilde;o</td>\n");
printf ("			<td>R$ <input name=\"custoPostoA\" type=\"text\" maxlength=\"3\" size=\"1\" onBlur=\"validarCampoNumerico(this)\">,00</td>\n");
printf ("		</tr>\n");
printf ("		\n");
printf ("		<!-- ESTUDANTE OU N&Atilde;O-ESTUDANTE -->\n");
printf ("		\n");
printf ("		<tr>\n");
...
printf ("			<td><input name=\"estudante\" type=\"radio\" value=\"nao_estudante\" onClick=\"ocultaLinha('parteA', 14)\">N&atilde;o-estudante</td>\n");
printf ("			<td></td>\n");
printf ("		</tr>\n");
printf ("		\n");
...
printf ("			<td><input name=\"estudantePerdeuAula\" type=\"radio\" value=\"nao\">N&atilde;o</td>\n");
printf ("			<td></td>\n");
printf ("		</tr>\n");
printf ("		\n");
printf ("		<!-- PROFISSAO -->\n");
...
printf ("			<td><input name=\"deixouGanharDinheiroA\" type=\"radio\" value=\"nao\" onclick=\"quantoDeixouGanharA.value='0'; quantoDeixouGanharA.readOnly = true\">N&atilde;o</td>\n");
...
printf ("			<td><input name=\"quemArcouCustos\" type=\"radio\" value=\"voce\" onClick=\"exibeLinhaOculta('parteA', 18)\">Voc&ecirc;</td>\n");
...
printf ("		<tr>\n");
printf ("			<td><input value=\"Limpar Formul&aacute;rio\" type=\"reset\"></td>\n");
printf ("			<td></td>\n");
printf ("			<td></td>\n");
