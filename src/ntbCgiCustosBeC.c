...
printf ("<html>\n");
printf ("<head>\n");
printf ("	<title>Question&aacute;rio Custos - Partes B e C</title>\n");
...
printf ("\n");
printf ("	tabFields[0] = [\"resultado_exames\", \"01 - Voc&ecirc; tem o resultado dos exames?\"];\n");
printf ("	tabFields[1] = [\"quantas_vezes_veio_ao_posto\", \"02 - Quantas vezes veio ao posto para pegar os resultados dos exames?\"];\n");
printf ("	tabFields[2] = [\"como_veio_ao_posto\", \"03 - Como voc&ecirc; veio ao posto? Em qual transporte?\"];\n");
printf ("	tabFields[3] = [\"custo_transporte\", \"03.1 - Quanto custou o transporte?\"];\n");
printf ("	tabFields[4] = [\"acompanhado\", \"04 - Voc&ecirc; est&aacute; acompanhado?\"];\n");
printf ("	tabFields[5] = [\"saida_casa\", \"05 - Que horas voc&ecirc; saiu de casa?\"];\n");
printf ("	tabFields[6] = [\"chegada_posto\", \"06 - Que horas voc&ecirc; chegou no posto?\"];\n");
printf ("	tabFields[7] = [\"viu_medico\", \"07 - Que horas voc&ecirc; viu o m&eacute;dico?\"];\n");
printf ("	tabFields[8] = [\"tempo_total\", \"08 - Quanto tempo levou desde que voc&ecirc; saiu de casa at&eacute; ver o m&eacute;dico?\"];\n");
printf ("	tabFields[9] = [\"segunda_amostra_escarro\", \"09 - Quando voc&ecirc; teve que trazer a 2&ordf; amostra de escarro h&aacute; alguns dias, em que hor&aacute;rio voc&ecirc; escarrou no potinho?\"];\n");
printf ("	tabFields[10] = [\"horario_escarrou\", \"10 - Que horas voc&ecirc; acordou no dia de escarrar pela segunda vez no potinho?\"];\n");
printf ("	tabFields[11] = [\"antibioticos\", \"11 - Voc&ecirc; recebeu uma receita com antibi&oacute;ticos?\"];\n");
printf ("	tabFields[12] = [\"rx\", \"12 - Voc&ecirc; pediu para fazer um RX?\"];\n");
printf ("	tabFields[13] = [\"comeu_bebeu\", \"13 - Desde que voc&ecirc; saiu de casa, voc&ecirc; comeu ou bebeu alguma coisa? Quanto custou?\"];\n");
printf ("	tabFields[14] = [\"pagar_algo_posto\", \"14 - Voc&ecirc; teve que pagar algo aqui no posto?\"];\n");
printf ("	tabFields[15] = [\"ganhar_dinheiro\", \"15 - Deixou de ganhar dinheiro hoje para poder vir ao posto? Quanto deixou de ganhar?\"];\n");
printf ("	tabFields[16] = [\"resultado_exames_escarro\", \"16 - Voc&ecirc; j&aacute; sabe o resutado dos exames de escarro?\"];\n");
printf ("	tabFields[17] = [\"registro_programa_tratamento_tb\", \"17 - Se o paciente tiver TB: Voc&ecirc; foi registrado no programa de tratamento de TB?\"];\n");
printf ("	tabFields[18] = [\"tempo_doente_diferente\", \"19 - H&aacute; quanto tempo voc&ecirc; estava sentindo-se diferente ou doente,antes de vir ao posto?\"];\n");
printf ("	tabFields[19] = [\"outra_unidade_saude\", \"20 - Antes de voc&ecirc; ser diagnosticado no posto, voc&ecirc; foi a alguma outra unidade de sa&uacute;de?\"];\n");
printf ("	tabFields[20] = [\"qual\", \"Este local era:\"];\n");
printf ("	tabFields[21] = [\"pagar_algo_posto\", \"18 - Voc&ecirc; teve que pagar algo aqui no posto?\"];\n");
printf ("	tabFields[22] = [\"registro_programa_tratamento_tb\", \"21 - Se o paciente tiver TB: Voc&ecirc; foi registrado no programa de tratamento de TB?\"];\n");
printf ("\n");
...
printf ("		else\n");
printf ("		{\n");
printf ("			document.getElementById(tabela).rows[3].style.display = \"none\";//Se o paciente tiver TB: Voc&ecirc; foi registrado no programa de tratamento de TB?(parte C)\n");
...
printf ("\n");
printf ("	<h3>Projeto - Novos M&eacute;todos Diagn&oacute;sicos em TB pulmonar - Policlinica Augusto Amaral Peixoto-SMS-RJ</br></h3>\n");
printf ("	<h4>Question&aacute;rio Custos</h4>\n");
printf ("	<i>(aplicar em 1 a cada 4 pacientes inclu&iacute;dos)</i>\n");
printf ("\n");
printf ("	<br /><br />\n");
printf ("\n");
...
printf ("			<td><input name=\"resultadoExames\" type=\"radio\" value=\"nao\">N&atilde;o</td>\n");
printf ("			<td></td>\n");
printf ("\n");
printf ("			<td></td>\n");
printf ("		</tr>\n");
...
printf ("			<td><input name=\"comoVeioPosto\" type=\"radio\" value=\"pe\" onClick=\"ocultaLinha('parteB', 3)\">A p&eacute;</td>\n");
printf ("\n");
printf ("			<td><input name=\"comoVeioPosto\" type=\"radio\" value=\"onibus\" onClick=\"exibeLinhaOculta('parteB', 3)\">&Ocirc;nibus</td>\n");
printf ("			<td colspan=\"2\"><input name=\"comoVeioPosto\" type=\"radio\" value=\"taxi_carro\" onClick=\"exibeLinhaOculta('parteB', 3)\">T&aacute;xi/carro</td>\n");
printf ("		</tr>\n");
printf ("		\n");
...
printf ("			<td><input name=\"acompanhadoB\" type=\"radio\" value=\"nao\" onClick=\"numeroAcompanhantesB.value='NA'; numeroAcompanhantesB.readOnly = true\">N&atilde;o</td>\n");
printf ("\n");
printf ("			<td colspan=\"2\">N&ordm; de pessoas: <input name=\"numeroAcompanhantesB\" type=\"text\" maxlength=\"2\" size=\"1\" onBlur=\"validarCampoNumerico(this)\"></td>\n");
printf ("		</tr>\n");
printf ("		\n");
...
printf ("\n");
printf ("			<td><input name=\"receitaAntibioticos\" type=\"radio\" value=\"nao\">N&atilde;o</td>\n");
printf ("			<td></td>\n");
printf ("			<td></td>\n");
printf ("		</tr>\n");
printf ("		\n");
...
printf ("\n");
printf ("			<td><input name=\"pediuRX\" type=\"radio\" value=\"nao\">N&atilde;o</td>\n");
printf ("			<td></td>\n");
printf ("			<td></td>\n");
printf ("		</tr>	\n");
printf ("		\n");
...
printf ("\n");
printf ("			<td><input name=\"comeuBebeuB\" type=\"radio\" value=\"nao\" onclick=\"custoComidaBebidaB.value='0'; custoComidaBebidaB.readOnly = true\">N&atilde;o</td>\n");
...
printf ("\n");
printf ("			<td><input name=\"pagarPostoB\" type=\"radio\" value=\"nao\" onclick=\"custoPostoB.value='0'; custoPostoB.readOnly = true\">N&atilde;o</td>\n");
...
printf ("\n");
printf ("			<td><input name=\"deixouGanharDinheiroB\" type=\"radio\" value=\"nao\" onclick=\"quantoDeixouGanharB.value='0'; quantoDeixouGanharB.readOnly = true\">N&atilde;o</td>\n");
...
printf ("\n");
printf ("			<td><input name=\"resultadoExameEscarro\" type=\"radio\" value=\"nao\">N&atilde;o</td>\n");
printf ("			<td></td>\n");
printf ("			<td></td>\n");
printf ("		</tr>\n");
printf ("		\n");
...
printf ("\n");
printf ("			<td><input name=\"programaTB\" type=\"radio\" value=\"nao\">N&atilde;o</td>\n");
printf ("			<td></td>\n");
printf ("			<td></td>\n");
printf ("		</tr>\n");
printf ("		</table>\n");
...
printf ("		<br />\n");
printf ("\n");
printf ("		<i>(Em caso de diagn&oacute;tico de TB pulmonar)</i>\n");
printf ("		\n");
...
printf ("			<td width=\"10%%\"><input name=\"pagarPostoC\" type=\"radio\" value=\"nao\" onclick=\"custoPostoC.value='0'; custoPostoC.readOnly = true\">N&atilde;o</td>\n");
printf ("\n");
...
printf ("			<td><input name=\"outraUnidadeSaude\" type=\"radio\" value=\"nao\" onClick=\"ocultaLinha('parteC', 3);ocultaLinha('parteC', 4)\">N&atilde;o</td>\n");
printf ("\n");
printf ("			<td></td>\n");
printf ("		</tr>\n");
printf ("		\n");
...
printf ("			<td><input name=\"naturezaLocal\" type=\"radio\" value=\"publico\" onClick=\"qual_outro.disabled = true; qual_outro.value='';\">P&uacute;blico</td>\n");
