...
/*******************************************************************************************************************************************************************************************/
	...
	printf ("	<br><input name=\"reacoesAdversasTuberculostaticosMenores\" type=\"checkbox\" value=\"nauseas_vomito\" disabled=\"true\">N&aacute;useas/Vomitos\n");
	...
	printf ("	<td colspan=\"4\"><input name=\"pesoAtual90dias\" type=\"text\" maxlength=\"5\" size=\"5\" onBlur=\"trabalharComCampoPeso(this);\"></td>\n");
	printf ("	</tr>\n");
	...
	printf ("	<td><input name=\"probabilidadeTBAtivaAposEstudoRX\" type=\"radio\" value=\"media\" onclick=\"desabilitarRadio(casoBaixaProbabilidade90dias,5);NSA90dias.disabled = false;habilitarRadio(cavitacao90dias,3); habilitarRadio(padraoTipico90dias,3); habilitarRadio(compativel90dias,3); habilitarRadio(atipico90dias,3);exibeLinhaOculta('tabelaFollowUp', 22);exibeLinhaOculta('tabelaFollowUp', 23);exibeLinhaOculta('tabelaFollowUp', 24);exibeLinhaOculta('tabelaFollowUp', 25);exibeLinhaOculta('tabelaFollowUp', 26);ocultaLinha('tabelaFollowUp', 27);ocultaLinha('tabelaFollowUp', 28)\">M&eacute;dia</td>\n");
