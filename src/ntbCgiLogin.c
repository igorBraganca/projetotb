...
int main (void)
{
	...
	if (!(returnCode = authenticateUser(username,password,&group)))
	{
		...
		printf("Location: triagem.cgi?uid=%s\r\n", username);
		printf("\r\n");
	}
	
	/* Mensagem de username ou senha invalido */
	else if ((returnCode==WRONG_PASSWORD) || (returnCode==USER_NOT_FOUND) || (returnCode==NULL_POINTER))
	{
		printf("\r\n");
		...
		printf ("\n");
		printf ("<img src=\"images/NeuralTB3.jpg\">\n");
		printf ("<br /><br />\n");
		printf ("<div class=\"\">\n");
		printf ("<table>\n");
		printf ("	<tr>\n");
		...
		printf ("					<td><input name=\"username\" type=\"text\"></td>\n");
		printf ("				</tr>\n");
		printf ("				<tr>\n");
		printf ("					<td style=\"text-align:right\">Senha:</td>\n");
		printf ("					<td><input name=\"password\" type=\"password\"></td>\n");
		printf ("				</tr>\n");
		printf ("				<tr>\n");
		...
		printf ("			</form>\n");
		printf ("		</td>\n");
		printf ("		<td style=\"padding-left:20px\"><img src=\"images/humanSmallest.jpg\" style=\"z-index:-1\"></td>\n");
		printf ("	</tr>\n");
		printf ("</table>\n");
		printf ("</div>\n");
		printf ("\n");
