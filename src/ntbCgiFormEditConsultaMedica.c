...
printf ("	tabFields[5] = [\"leitura_data\", \"Data da leitura (dia/mês/ano):\"];\n");
...
printf ("	\n");
printf ("	\n");
printf ("	var tabValores= new Array(\"Masculino\", \"Feminino\", \"Presente\", \"Ausente\", \"Ignorado\",\"Sim\", \"N&etilde;o\", \"Branco\", \"N&etilde;o-branco\", \"Negro\", \"Mulato\", \"Ãndio\", \"AsiÃ¡tico\", \"Outro\", \"Casado\", \"Solteiro\", \"Separado\", \"ViÃºvo\", \"PulmÃ£o\", \"Pleura\", \"G&acirc;nglio\");\n");
printf ("\n");
