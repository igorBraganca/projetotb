...
int main (void)/*(int argc,char**argv)*/
{
	...
	*/
	...
	printf ("	tabFields[28] = [\"nsa\", \"10.4 - Atípico (qualquer outro padrão):\"];\n");
	...
	printf ("	tabFields[39] = [\"numeroGeral\",\"N&#186; Geral (TB Adapt): \"];\n");
	printf ("	tabFields[40] = [\"dia_inclusao\",\"Data de inclus&atilde;o&nbsp;:&nbsp;\"];\n");
	printf ("	tabFields[41] = [\"mes_inclusao\",\"Data de inclus&atilde;o&nbsp;:&nbsp;\"];\n");
	printf ("	tabFields[42] = [\"ano_inclusao\",\"Data de inclus&atilde;o&nbsp;:&nbsp;\"];\n");
	printf ("	tabFields[43] = [\"resultadoBaciloscopia1\",\"14 - #1:\"];\n");
	printf ("	tabFields[44] = [\"casoPositivo1\",\"14.1 - Se positivo (1):\"];\n");
	printf ("	tabFields[45] = [\"resultadoBaciloscopia2\",\"15 - #2:\"];\n");
	printf ("	tabFields[46] = [\"casoPositivo2\",\"15.1 - Se positivo:\"];\n");
	printf ("	tabFields[47] = [\"observacoes\",\" 21 - Observa&ccedil;&otilde;es: \"];\n");
...
/*******************************************************************************************************************************************************************************************/
	...
	printf ("	<!-- --><div class=\"h4\"><b><script>document.write(tabFields[39][1]);</script><input name=\"numeroGeral\" size=\"6\" type=\"text\" value=\"\" readonly=\"readonly\"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;\n");
	printf ("		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;\n");
	printf ("		<script>document.write(tabFields[40][1]);</script><input maxlength=\"2\" size=\"2\" name=\"dia_inclusao\" onKeyUp=\"if(this.value.length == 2)if(validarDia(this))mes_inclusao.focus();\" onChange=\"if(validarDia(this))mes_inclusao.focus();\">&nbsp;/\n");
	...
	*/
	...
	printf ("		<td colspan=\"3\"><input name=\"mes_quimio\" type=\"text\" maxlength=\"2\" size=\"2\" disabled=\"sim\" onKeyUp=\"if(this.value.length == 2)this.blur();\" onChange=\"if(validarMes(this))ano_quimio.focus();\"> (m&ecirc;s) / <input name=\"ano_quimio\" type=\"text\" maxlength=\"4\" size=\"4\" disabled=\"sim\" onKeyUp=\"if(this.value.length == 4)this.blur();\" onChange=\"validarAno(this);\" onBlur=\"validarQualquerData(1,mes_quimio,ano_quimio);validarDataExame(0,mes_quimio,ano_quimio)\"> (ano)</td>\n");
	printf ("	</tr>\n");
	printf ("	<!-- DESFECHO -->\n");
	printf ("	\n");
	printf ("	<tr class=\"impar\">\n");
	...
	printf ("		<td colspan=\"3\">\n");
	printf ("			<input name=\"desfechoConsultaInicial\" type=\"radio\" value=\"tb_confirmacao\" onClick=\"habilitarRadio(casoTratamentoTB,4) ;habilitarRadio(fatoresRisco,3) ;exibeLinhaOculta('tabelaGenpoint', 45);exibeLinhaOculta('tabelaGenpoint', 46);exibeLinhaOculta('tabelaGenpoint', 47)\">Tratamento impara TB com confirma&ccedil;&atilde;o bacteriol&oacute;gica;\n");
	printf ("			<p><input name=\"desfechoConsultaInicial\" type=\"radio\" value=\"tb_probabilidade\" onClick=\"habilitarRadio(casoTratamentoTB,4) ;habilitarRadio(fatoresRisco,3) ;exibeLinhaOculta('tabelaGenpoint', 45);exibeLinhaOculta('tabelaGenpoint', 46);exibeLinhaOculta('tabelaGenpoint', 47)\">Tratamento impara TB por probabilidade;</p>\n");
	...
	printf ("			<p><input name=\"desfechoConsultaInicial\" type=\"radio\" value=\"internacao\" onClick=\"desabilitarRadio(casoTratamentoTB,4) ;desabilitarRadio(fatoresRisco,3) ;ocultaLinha('tabelaGenpoint', 45);ocultaLinha('tabelaGenpoint', 46);ocultaLinha('tabelaGenpoint', 47)\">Transfer&ecirc;ncia impara interna&ccedil;&atilde;o N&atilde;o por TB ou tratamento<br> em outra especialidade</br></p>\n");
