...
int main (void)/*(int argc,char**argv)*/
{
	...
	*/
	...
	printf ("	tabFields[34] = [\"prob_tb_ativa_com_rx_baar\", \"17 - Qual a probabilidade do diagn&oacute;stico de TB pulmonar ativa com a avalia&ccedil;&atilde;o do RX de t&oacute;rax e do BAAR?\"];\n");
